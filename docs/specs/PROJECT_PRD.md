...
维护角色: Planner
当前正式产品基线: `main` includes F-013 and F-014 through PR #10, merge commit `a91102f`
...
- 当前规划切片是 F-015: 增强提醒复核列表、证据抽屉、人工状态和复核备注的前端工作流, 仍只使用本地或 fixture 状态。
- F-015 的复核状态与备注必须是本地 UI 状态或 fixture 展示状态, 不能暗示已保存到生产系统。
